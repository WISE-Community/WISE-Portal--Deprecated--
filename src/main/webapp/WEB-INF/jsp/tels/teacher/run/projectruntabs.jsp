				  ...
				  <tr id="runTitleRow_${run.id}">
				    ...
				    <td style="vertical-align:top; padding:1px 0;">
					    ...
					    <c:set var="isExternalProject" value="0"/>
							...
							<li><spring:message code="teacher.run.myprojectruns.16"/> (<spring:message code="teacher.run.myprojectruns.41"/>:<a href="../grading/gradework.html?runId=${run.id}&gradingType=step&getRevisions=false&minified=true" target="_top"><spring:message code="teacher.run.myprojectruns.43"/></a>|<a href="../grading/gradework.html?runId=${run.id}&gradingType=step&getRevisions=true&minified=true" target="_top"><spring:message code="teacher.run.myprojectruns.42"/></a>)</li>
   	                        <li><spring:message code="teacher.run.myprojectruns.17"/> (<spring:message code="teacher.run.myprojectruns.41"/>:<a href="../grading/gradework.html?runId=${run.id}&gradingType=team&getRevisions=false&minified=true" target="_top"><spring:message code="teacher.run.myprojectruns.43"/></a>|<a href="../grading/gradework.html?runId=${run.id}&gradingType=team&getRevisions=true&minified=true" target="_top"><spring:message code="teacher.run.myprojectruns.42"/></a>)</li>				    	
