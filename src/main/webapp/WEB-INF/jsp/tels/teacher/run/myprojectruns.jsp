...
<title><spring:message code="teacher.run.myprojectruns.myClassroomRuns" /></title>
		...
		<div id="pageContent">
			...
			<div class="contentPanel">
				...
				<div class="panelHeader">
					<spring:message code="teacher.run.myprojectruns.myClassroomRuns" />
					<span class="pageTitle"><spring:message code="teacher.run.myprojectruns.management"/></span>
				</div>
