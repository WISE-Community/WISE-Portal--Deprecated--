...
var Dom = YAHOO.util.Dom,
    ...
    */
    ...
    YAHOO.extend(YAHOO.widget.SimpleEditor, YAHOO.util.Element, {
        ...
        * @type Object
        */
        _semantic: { 'bold': true, 'italic' : true, 'underline' : true, 'codediv' : true  },
        /**
        * @private
        * @property _tag2cmd
        ...
        */
         ...
         */
         cmd_removeformat: function(value) {
            ...
            if (this._hasParent(el, 'pre')) {
                this.currentElement[0] = this._hasParent(el, 'pre');
            } else if (!this._isElement(el, 'pre')) {
                this._createCurrentElement('pre');
                _a = this._swapEl(this.currentElement[0], 'pre');
...
var Dom = YAHOO.util.Dom,
    ...
    */
    ...
    YAHOO.extend(YAHOO.widget.Editor, YAHOO.widget.SimpleEditor, {
        ...
        */
        cmd_removeformatold: function(value) {
            var exec = true;
            /**
